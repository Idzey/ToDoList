    ...
    return (
        <div className='h-1/4 flex flex-col justify-between rounded-sm'>
            ...
            <div className='flex gap-10 h-full justify-center items-center p-5'>
                <input ref={inputRef} onKeyDown={downEnter} onChange={evt => setName(evt.target.value)} type="text" name="" id="" placeholder='Name task...' className='p-3 bg-zinc-700 w-70' />
                <label className={"inline-flex items-center cursor-pointer"}>
                    <input ref={checkRef} onClick={checkClick} type="checkbox" name="" id=""  className="sr-only peer"/>
